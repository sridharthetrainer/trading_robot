...
TASK SCHEDULE:
  ...
  SAT 12PM : Deep ML training (60-day window)
...
class OffHoursEngine:
    ...
    def run_holiday_tasks(self) -> None:
        ...
        tasks = [
            ...
            ("Deep ML training (60d)",      self._run_deep_ml),
    ...
    def _run_next_week_plan(self) -> None:
        ...
        msg = (
            ...
            f"  ☑️ Go-live decision when paper WR > 55% for 30 days\n"
        )
        self._send(msg)
