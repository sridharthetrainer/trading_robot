...
class TelegramCommandHandler:
    ...
    def _cmd_market_score(self, _="") -> str:
        ...
        try:
            ...
            # 3. FII flows
            try:
                from fii_data_fetcher import get_latest_fii
                fii = get_latest_fii()
    ...
    def _cmd_diagnose(self, _="") -> str:
        ...
        try:
            ...
            try:
                from daily_loss_limit import get_daily_loss_manager
                dlm = get_daily_loss_manager()
                can = dlm.can_trade()
    ...
    def _cmd_broker(self, _="") -> str:
        ...
        try:
            ...
            # Check Dhan status
            try:
                from dhan_client import is_configured as dhan_ok, is_connected as dhan_live
