...
def _score_data_pipeline(checks: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    parts["storage_capture"] = {
        ...
        "detail": (
            f"candles={candles}, signals={signals}, option_snaps={option_snaps}, "
    ...
    parts["learning_readiness"] = {
        ...
        "detail": f"live_ready={live_ready}/{total_strategies}, selected={selected}, shadow={shadow}",
    }
...
def _score_institutional_readiness(checks: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    parts = {
        ...
        "execution_fill_quality": {
            "score": 10 if trades >= 100 else 6 if trades >= 10 else 3 if covered("execution_fill_quality") else 0,
            "max": 12,
