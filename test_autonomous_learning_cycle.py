...
def test_cycle_dry_run_has_required_steps() -> bool:
    ...
    return (
        ...
        and "candle_coverage_backfill" in steps
        ...
        and "option_structure_mining" in steps
        ...
        and "candle_backfill_skipped=" in summary
        and "snapshots market_skipped=" in summary
        and "option structure skipped=" in summary
