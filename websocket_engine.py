...
class WebSocketEngine:
    ...
    def register_tick_callback(self, callback) -> None:
        """
        Register an external callback(symbol: str, ltp: float) → None.
        Called on every tick after LTPCache is updated. Used by tick_order_flow.
        """
    ...
    def _check_ws_available(self) -> bool:
        try:
            from SmartApi.smartWebSocketV2 import SmartWebSocketV2 as _WS  # noqa
            return True
        except ImportError:
            return False
