...
from hero_zero_strategy import get_hero_zero_strikes, select_hero_zero_candidate
...
def test_illiquid_cheap_contract_rejected() -> bool:
    option_data = {
        "chain": [
...
def test_best_candidate_prefers_quality_not_cheapest() -> bool:
    option_data = {
        "chain": [
    ...
    return selected is not None and selected["strike"] == 20600


def test_wide_spread_rejected() -> bool:
    option_data = {
        "chain": [
