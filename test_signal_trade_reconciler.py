...
def test_reconcile_updates_matching_signal() -> bool:
...
def test_reconcile_is_idempotent() -> bool:
    with tempfile.TemporaryDirectory() as tmp:
        trades, signals = _make_dbs(tmp)
        ...
        return first["updated"] == 1 and second["already_linked"] == 1 and second["updated"] == 0
