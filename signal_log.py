...
CREATE TABLE IF NOT EXISTS {_TBL} (
    ...
    heikin_direction REAL DEFAULT 0,
    heikin_run REAL DEFAULT 0,
    heikin_reversal REAL DEFAULT 0,
    heikin_body_atr REAL DEFAULT 0,
    heikin_upper_wick_atr REAL DEFAULT 0,
    heikin_lower_wick_atr REAL DEFAULT 0,
    ...
    def log_candidate(
        ...
        try:
            ...
            row = {
                ...
                "heikin_direction": float(representation_ctx.get("heikin_direction", 0) or 0),
                "heikin_run": float(representation_ctx.get("heikin_run", 0) or 0),
                "heikin_reversal": float(representation_ctx.get("heikin_reversal", 0) or 0),
                "heikin_body_atr": float(representation_ctx.get("heikin_body_atr", 0) or 0),
                "heikin_upper_wick_atr": float(representation_ctx.get("heikin_upper_wick_atr", 0) or 0),
                "heikin_lower_wick_atr": float(representation_ctx.get("heikin_lower_wick_atr", 0) or 0),
