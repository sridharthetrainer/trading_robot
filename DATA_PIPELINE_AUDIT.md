...
- Generated: `2026-07-21T16:10:43+0530`
- Status: `PASS`
- Fetch sample: `3`
- Internet probe: `True`
...
- `storage_capture` `15/15` - candles=3484159, 1m_symbols=193, 1d_symbols=196, signals=29083, option_snaps=3088, historical_options=3171931, confluence=27809, coverage_plan=yes
- `learning_readiness` `7.0/10` - live_ready=0/102, selected=807, shadow=6463, param_promoted=0, param_paper=3, fill_trades=12, derived_daily_symbols=193, bad_candle_groups=30/969, experiments=18
...
- `tick_or_1sec_data` `8/10` - tick modules=True, candles=3484159
- `all_strike_option_history` `14/15` - option_snapshots=3088, historical_options=3171931
...
- `labelled_learning_dataset` `10/18` - labelled=17993/5000, days=14/15
- `participant_fii_flows` `10/10` - participant OI plus FII/DII flow coverage
- `market_profile_history` `8/8` - profile_snapshots=98145
...
- `PASS` `storage`
  - trades `12`, signals `29083`, candles `3484159`, candle meta `970`, option snaps `3088`, profile snaps `98145`, historical options `3171931`, market snaps `264`, confluence `27809`, nse hub `10/10`, journal exists `True`
- `PASS` `learning_files`
  - live-ready `0/102`, autotune selected `807`, shadow `6463`
- `PASS` `labelled_dataset`
  - labelled `17993/29083`, days `14`, executed `3`
- `PASS` `fetch_sample`
  - ok `3/3`
