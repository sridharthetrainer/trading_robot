...
def test_option_metadata_wiring():
    ...
    print(f"   option_expiry: '{opt_expiry_new}' (should be '2026-06-17')")
    ...
    checks = [
        ...
        ("option_expiry", opt_expiry_new, "2026-06-17"),
...
if __name__ == "__main__":
    try:
        success = test_option_metadata_wiring()
