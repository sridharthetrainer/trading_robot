...
AI_FILTER_THRESHOLD        = _fenv("AI_FILTER_THRESHOLD", 2.0)
...
# Live:          higher threshold (0.58) — stricter gate on real capital
ML_CONFIDENCE_LIVE:   float = _fenv("ML_CONFIDENCE_LIVE", 0.58)
