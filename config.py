...
LIVE_PROBATION_REQUIRE_SYSTEM_HEALTH = _benv("LIVE_PROBATION_REQUIRE_SYSTEM_HEALTH", True)
LIVE_PROBATION_MAX_OPTION_SNAPSHOT_AGE_SEC = _ienv("LIVE_PROBATION_MAX_OPTION_SNAPSHOT_AGE_SEC", 300)
LIVE_PROBATION_MAX_HEALTH_SNAPSHOT_AGE_SEC = _ienv("LIVE_PROBATION_MAX_HEALTH_SNAPSHOT_AGE_SEC", 900)
...
REQUIRE_SELECTED_OPTION_LIQUIDITY_FIELDS = _benv("REQUIRE_SELECTED_OPTION_LIQUIDITY_FIELDS", True)
...
MAX_SELECTED_OPTION_SPREAD_PCT = _fenv("MAX_SELECTED_OPTION_SPREAD_PCT", 0.05)
...
# Focused single-strike option funnel. It is deliberately PAPER-only until
# segmented (underlying + CE/PE) cohorts pass the existing holdout policy.
OPTION_FOCUSED_PAPER_ENABLED = _benv("OPTION_FOCUSED_PAPER_ENABLED", True)
OPTION_FOCUSED_MIN_SCORE = _fenv("OPTION_FOCUSED_MIN_SCORE", 70.0)
OPTION_FOCUSED_MAX_SPREAD_PCT = _fenv("OPTION_FOCUSED_MAX_SPREAD_PCT", 0.03)
OPTION_FOCUSED_MAX_DTE = _ienv("OPTION_FOCUSED_MAX_DTE", 7)
OPTION_FOCUSED_COOLDOWN_SEC = _ienv("OPTION_FOCUSED_COOLDOWN_SEC", 3600)
OPTION_FOCUSED_MAX_OPEN_AGE_SEC = _ienv("OPTION_FOCUSED_MAX_OPEN_AGE_SEC", 14400)
OPTION_FOCUSED_THETA_BUFFER_PCT = _fenv("OPTION_FOCUSED_THETA_BUFFER_PCT", 0.005)
OPTION_FOCUSED_RISK_PCT = _fenv("OPTION_FOCUSED_RISK_PCT", 0.0025)
...
# 2026-07-16: 42-strategy option catalog (option_strategy_registry.py /
# option_core_strategies.py), shadow/journal-only in this pass -- no order
# placement, so these have no live effect yet beyond gating whether the
# catalog runs and what its (unwired) pure risk checks compute.
ENABLE_OPTION_STRATEGY_CATALOG = _benv("ENABLE_OPTION_STRATEGY_CATALOG", True)
OPTION_STRATEGY_PARAMS_FILE = _env("OPTION_STRATEGY_PARAMS_FILE", "option_strategy_params.json")
OPTION_STRATEGY_CATALOG_REGIME_TTL_SEC = _ienv("OPTION_STRATEGY_CATALOG_REGIME_TTL_SEC", 300)
OPTION_STRATEGY_MTM_STOP_PCT = _fenv("OPTION_STRATEGY_MTM_STOP_PCT", 0.015)
OPTION_STRATEGY_VIX_BLOCK_ALL = _fenv("OPTION_STRATEGY_VIX_BLOCK_ALL", 25.0)
OPTION_STRATEGY_VIX_BLOCK_NONDIRECTIONAL = _fenv("OPTION_STRATEGY_VIX_BLOCK_NONDIRECTIONAL", 30.0)
